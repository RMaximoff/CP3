...
def test_hide_numbers():
    ...
    assert isinstance(main.hide_numbers(sorted_operations), list)
    hidden_operations = main.hide_numbers(sorted_operations)
...
def test_print_last_operations(capsys):
    ...
    operations_list = [{'id': 114832369, 'state': 'EXECUTED', 'date': '2019-12-07T06:17:14.634890',
                        ...
                        'to': 'Счет 35158586384610753655', 'type_from': 'Visa Classic ', 'num_from': '2842 78** **** 9012',
                       ...
                       {'id': 154927927, 'state': 'EXECUTED', 'date': '2019-11-19T09:22:25.899614',
                        ...
                        'type_from': 'Maestro ', 'num_from': '7810 46** **** 5568', 'type_to': 'Счет ', 'num_to': '**2869'},
                       ...
                       {'id': 509645757, 'state': 'EXECUTED', 'date': '2019-10-30T01:49:52.939296',
                        ...
                        'description': 'Перевод с карты на счет', 'from': 'Visa Gold 7756673469642839', 'to': 'Счет 48943806953649539453',
                        'type_from': 'Visa Gold ', 'num_from': '7756 73** **** 2839', 'type_to': 'Счет ', 'num_to': '**9453'},
                       {'id': 888407131, 'state': 'EXECUTED', 'date': '2019-09-29T14:25:28.588059',
                        'operationAmount': {'amount': '45849.53', 'currency': {'name': 'USD', 'code': 'USD'}},
                        'description': 'Перевод со счета на счет', 'from': 'Счет 35421428450077339637', 'to': 'Счет 46723050671868944961',
